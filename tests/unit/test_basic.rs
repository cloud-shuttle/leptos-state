...
#[test]
fn test_basic_machine_transition() {
    let machine = MachineBuilder::new()
        .state("idle", |_| TestState::Idle)
        .state("active", |_| TestState::Active)
...
#[test]
fn test_basic_machine_invalid_transition() {
    let machine = MachineBuilder::new()
        .state("idle", |_| TestState::Idle)
        .state("active", |_| TestState::Active)
        .initial("idle")
...
#[test]
fn test_basic_machine_context() {
    let machine = MachineBuilder::new()
        .state("counter", |ctx| TestState::Counter(ctx.counter))
        .initial("counter")
        .build();

    let context = TestContext { counter: 42, name: "test".to_string(), is_active: false };
...
#[test]
fn test_basic_machine_multiple_transitions() {
    let machine = MachineBuilder::new()
        .state("idle", |_| TestState::Idle)
        .state("active", |_| TestState::Active)
...
#[test]
fn test_basic_machine_state_validation() {
...
#[test]
fn test_basic_machine_empty_states() {
    let machine = MachineBuilder::new()
        .initial("idle")
        .build();
...
#[test]
fn test_basic_machine_context_update() {
    let machine = MachineBuilder::new()
        .state("idle", |_| TestState::Idle)
        .state("active", |_| TestState::Active)
        .transition("idle", "start", "active")
    ...
    let mut state = MachineState::new(&machine, TestContext { counter: 0, name: "test".to_string(), is_active: false });
...
#[test]
fn test_basic_machine_builder_fluent_api() {
    let machine = MachineBuilder::new()
        .state("idle", |_| TestState::Idle)
        .state("active", |_| TestState::Active)
