...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbindgen_cast_284f10be78f5a697 = function(arg0, arg1) {
        // Cast intrinsic for `Closure(Closure { dtor_idx: 61, function: Function { arguments: [NamedExternref("Event")], shim_idx: 62, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
        const ret = makeMutClosure(arg0, arg1, 61, __wbg_adapter_11);
        return ret;
    };
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('traffic_light_example_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
