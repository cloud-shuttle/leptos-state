...
impl<C: std::fmt::Debug + 'static, E: std::fmt::Debug + PartialEq + 'static> GuardEvaluator<C, E> for AndGuard<C, E> {
...
impl<C: std::fmt::Debug + 'static, E: std::fmt::Debug + PartialEq + 'static> GuardEvaluator<C, E> for OrGuard<C, E> {
    fn check(&self, context: &C, event: &E) -> bool {
...
impl<C: std::fmt::Debug + 'static, E: std::fmt::Debug + PartialEq + 'static> GuardEvaluator<C, E> for NotGuard<C, E> {
    fn check(&self, context: &C, event: &E) -> bool {
...
impl<C: std::fmt::Debug + 'static, E: std::fmt::Debug + PartialEq + 'static> GuardEvaluator<C, E> for XorGuard<C, E> {
    fn check(&self, context: &C, event: &E) -> bool {
        self.guards
            .iter()
...
impl<C: std::fmt::Debug + 'static, E: std::fmt::Debug + PartialEq + 'static> GuardEvaluator<C, E> for MajorityGuard<C, E> {
    fn check(&self, context: &C, event: &E) -> bool {
