...
pub use history_core::{HistoryState, HistoryConfig, HistoryEvent, HistoryEntry, HistoryStats};
pub use history_machine::{MachineHistoryExt, HistoryMachineBuilder};
pub use history_tracker::{HistoryIterator, HistorySnapshot};
pub use history_builder::{history_builder, factory, utils, handlers};
pub use integration::{IntegrationAdapter, IntegrationManager};
pub use integration_config::{IntegrationConfig, EventRoutingConfig, RoutingRule, EventPattern, EventTransformation, RetryConfig, ConnectionConfig, Credentials, PoolConfig};
pub use integration_events::{IntegrationEvent, EventPriority, ErrorHandlingStrategy, ErrorAction, IntegrationError, IntegrationErrorType, EventBatch, EventFilter};
pub use integration_core::{AdapterType, IntegrationMetrics, MachineIntegrationExt, IntegrationBuilder, IntegrationAdapterTrait, HealthStatus};
